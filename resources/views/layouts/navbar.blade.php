<nav class="bg-[#0f049f] ">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      ...
      <a href="/" class="flex items-center w-[80%] md:w-[35%] lg:w-[40%]">
          <img src="{{asset("img/logo/main-logo.png")}}" class="h-auto sm:w-[35%] md:w-[80%] lg:w-[25%] w-[65%]" alt="Flowbite Logo" />     
      </a>
      ...
      <div class="hidden w-full md:block md:w-auto" id="navbar-default">
        <ul class="md:font-medium sm:text-sm md:text-base	 flex flex-col p-4 md:p-0   bg-[#0f049f] md:flex-row md:space-x-8">
          <li>
